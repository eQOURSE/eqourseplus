# eQOURSE+ — SaaS Requirements Specification (SPEC.md) v2.5 — Global Edition
...
## 22. Foundation & Public-Site Requirements (Phase 0–1 FR IDs — added v2.1; FR-PUB-00 added v2.5)
...
Ordering rule: FND-01→06 strictly sequential; PUB-00→01..06 then FR-SEO-01. FR-SEO-01 must not begin before FR-FND-01/05 are done.
