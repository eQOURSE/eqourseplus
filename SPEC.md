# eQOURSE+ — SaaS Requirements Specification (SPEC.md) v2.19 — Global Edition
...
The `vendors` and `profiles` collections are specified in Section 19.2.
