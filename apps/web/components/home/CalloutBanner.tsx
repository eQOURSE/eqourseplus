    ...
    <section id="final-cta" className={styles.finalCta} data-home-region aria-labelledby="final-cta-title">
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.heroActions}>
          ...
          <Link className="eq-glass-button eq-glass-button--secondary eq-glass-surface eq-glass-tier-regular home-cta" href="/register/vendor"><span className="eq-glass-button__label">Register as Agency Partner</span></Link>
