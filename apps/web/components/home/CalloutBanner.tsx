  ...
  return (
    <section id="final-cta" className={styles.finalCta} data-home-region aria-labelledby="final-cta-title">
      ...
      <div className={styles.inner}>
        ...
        <p>Whether you are an expert ready to work on your terms, an agency seeking enterprise grade pipelines, or a frontier lab building next-generation models, step into an ecosystem designed for clarity, respect, and growth.</p>
